...
CREATE TABLE `gallery` (
  ...
  `tipe_layout` enum('square','large','wide') COLLATE utf8mb4_unicode_ci DEFAULT 'square',
...
CREATE TABLE `navbar` (
  ...
  CONSTRAINT `navbar_ibfk_1` FOREIGN KEY (`parent_id`) REFERENCES `navbar` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `navbar` (`id`, `parent_id`, `nama_menu`, `url`, `urutan`) VALUES
(1, NULL, 'BERANDA',  '#',  0),
(29,  NULL, 'PROFIL', '#',  1),
(30,  29, 'SEJARAH',  'page.php?slug=sejarah',  0),
(31,  NULL, 'ARSIP',  '#',  3),
...
CREATE TABLE `posts` (
  ...
  `kategori` enum('berita','informasi','artikel') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `settings` (
  `id` int NOT NULL AUTO_INCREMENT,
  `setting_group` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'system',
  `setting_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `setting_value` text COLLATE utf8mb4_general_ci,
  `setting_type` enum('text','textarea','email','number','select','url','file') COLLATE utf8mb4_general_ci DEFAULT 'text',
...
(1, 'admin',  '$2y$12$BUJypcUBcpm/pd3t/QLOheILDdndv9TntzsAhgfk9JmHxMgqvrFTm', 'Tuan Admin', 'admin',  NULL, 'user_2b926df11584937a.webp', '2026-01-25 07:13:02');
...
CREATE TABLE `widgets` (
  ...
  `layout_position` enum('library','left','center','right') COLLATE utf8mb4_general_ci DEFAULT 'library',
