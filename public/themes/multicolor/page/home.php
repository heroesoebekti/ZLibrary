                    ...
                    if ($widget_info) {
                        ...
                        if (file_exists($file)) {
                            ...
                            if (!empty($widget_info['title'])) {
                                ...
                                echo '<span class="w-1.5 h-4 rounded-full" style="background-color: var(--nav-accent);"></span>' . htmlspecialchars($widget_info['title']) . '</h3>';
                            }
...
<section class="relative py-28 md:py-40 overflow-hidden banner" style="background-color: var(--nav-dark);">
