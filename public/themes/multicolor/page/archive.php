        ...
        <div class="grid grid-cols-1 gap-8">
                    ...
                    <div class="p-6 flex flex-col justify-between flex-1">
                        <div>
                            <div class="flex items-center gap-3 mb-2">
                                <span class="text-xs font-bold px-2 py-1 rounded archive-badge uppercase">
                            ...
                            <h2 class="text-2xl font-bold text-gray-800 mb-3">
                                <a href="<?= BASE_URL ?>/post/<?= strip_tags($p['slug']); ?>" class="transition archive-link">
                                    <?= strip_tags($p['judul']); ?>
                                </a>
                            </h2>
                        ...
                        <div class="mt-4">
                            <a href="<?= BASE_URL ?>/post/<?= strip_tags($p['slug']); ?>" class="font-bold inline-flex items-center group archive-link">
            ...
            <?php else: ?>
                <div class="text-center py-20">
                    ...
                    <p class="text-gray-500 italic text-xl"><?= __('Belum ada konten yang tersedia.') ?></p>
                    <a href="<?= BASE_URL ?>" class="mt-4 inline-block font-medium archive-link hover:underline">
